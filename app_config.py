...
PROJECT_SLUG = 'budget-address-factcheck-2017'

# Project name to be used in file paths
PROJECT_FILENAME = 'budget_address_factcheck_2017'

# The name of the repository containing the source
REPOSITORY_NAME = 'budget-address-factcheck-2017'
...
CURRENT_DEBATE = 'budget-address-factcheck-2017'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1XHult8gCRPGmeYJu5PHsiJNIkDOI7x-111gRfi6KwLs'
